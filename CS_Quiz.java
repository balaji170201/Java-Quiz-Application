...
public class CS_Quiz extends JFrame {
	public JPanel panel;
	...
	JLabel cbquiz;
	  public static void main(String args[])
	    ...
	    public CS_Quiz()
	    {
			...
			JLabel cbquiz = new JLabel("CS_QUIZ");
			cbquiz.setText("CS_QUIZ");
